...
import { trackAppInstallation } from '@/lib/analytics/gtm';
...
export default function ClientSuccessPage({ appType, portalId, config }: ClientSuccessPageProps) {
  const dashboardUrl = portalId ? `/dashboard?portalId=${portalId}` : '/dashboard';

  useEffect(() => {
    // Track successful installation
    if (appType && portalId) {
      trackAppInstallation(Number(portalId), appType, true);
    }
  }, [appType, portalId]);
