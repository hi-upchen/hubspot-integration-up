...
const variantStyles = {
  solid: {
    ...
    hubspot: 'bg-[rgb(255,122,89)] text-white hover:text-slate-100 hover:bg-[rgb(245,112,79)] active:bg-[rgb(235,102,69)] active:text-white focus-visible:outline-[rgb(255,122,89)]',
    white:
